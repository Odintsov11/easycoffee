...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _modules_bubble_buttons_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/bubble-buttons.js */ \"./src/js/modules/bubble-buttons.js\");\n/* harmony import */ var _modules_range_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/range.js */ \"./src/js/modules/range.js\");\n/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modal.js */ \"./src/js/modules/modal.js\");\n/* harmony import */ var _modules_calc_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calc.js */ \"./src/js/modules/calc.js\");\n\n\n\n\n\n\n\n\n\ndocument.addEventListener('DOMContentLoaded', () => {\n    _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\n    (0,_modules_bubble_buttons_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n    (0,_modules_range_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n    (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n    (0,_modules_calc_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n});\n\n//# sourceURL=webpack://start-template/./src/js/app.js?");

/***/ }),

/***/ "./src/js/modules/bubble-buttons.js":
/*!******************************************!*\
  !*** ./src/js/modules/bubble-buttons.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst bubbleButtons = () => {\n    const animateButton = function(e) {\n    console.log('click');\n      e.preventDefault(); // Правильное использование preventDefault()\n  \n      // Сброс анимации\n      e.target.classList.remove('animate');\n\n      // Добавление класса для запуска анимации\n      e.target.classList.add('animate');\n      \n      // Удаление класса анимации через 700ms\n      setTimeout(() => {\n        e.target.classList.remove('animate');\n      }, 700);\n    };\n  \n    const bubblyButtons = document.querySelectorAll(\".button\");\n    \n    // Назначение обработчика события click для каждой кнопки\n    bubblyButtons.forEach(btn => {\n      btn.addEventListener('click', animateButton, false);\n    });\n  };\n  \n  /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (bubbleButtons);\n\n//# sourceURL=webpack://start-template/./src/js/modules/bubble-buttons.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst calculator = () => {\n    // Получаем элементы DOM, с которыми будем взаимодействовать\n    const itemList = document.querySelectorAll('.calc__item');\n    const rangeInput = document.querySelector('.range');\n    const outputValue = document.querySelector('.output');\n    const priceDisplay = document.querySelector('.calc__price');\n\n    // Функция для обновления цены калькулятора\n    function updatePrice() {\n        // Находим выбранный элемент списка кофе\n        const selectedItem = document.querySelector('.calc__item--active');\n        if (!selectedItem) return; // Если нет активного элемента, выходим\n\n        // Получаем цену из атрибута data-price активного элемента\n        const coffeePrice = parseInt(selectedItem.dataset.price);\n\n        // Получаем текущее значение ползунка (количество кг кофе в месяц)\n        const coffeeAmount = parseInt(outputValue.value);\n\n        // Вычисляем общую стоимость (цена за кг * количество кг)\n        const totalPrice = coffeePrice * coffeeAmount;\n\n        // Отображаем общую стоимость в блоке с ценой\n        priceDisplay.textContent = `${totalPrice} ₴`;\n    }\n\n    // Обработчик клика по элементам списка кофе\n    itemList.forEach(item => {\n        item.addEventListener('click', () => {\n            // Удаляем класс активности у всех элементов списка\n            itemList.forEach(item => item.classList.remove('calc__item--active'));\n\n            // Добавляем класс активности только выбранному элементу\n            item.classList.add('calc__item--active');\n\n            // После смены выбора обновляем цену\n            updatePrice();\n        });\n    });\n\n    // Обработчик изменения значения ползунка range\n    rangeInput.addEventListener('click', () => {\n        // После изменения значения ползунка обновляем цену\n        updatePrice();\n    });\n\n    // Обработчик изменения значения ползунка range\n    rangeInput.addEventListener('touchmove', () => {\n        // После изменения значения ползунка обновляем цену\n        updatePrice();\n    });\n\n    // Вызываем функцию updatePrice() при загрузке страницы для начального расчета цены\n    updatePrice();\n\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (calculator);\n\n\n//# sourceURL=webpack://start-template/./src/js/modules/calc.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst modals = () => {\n    function bindModal(triggerSelector, modalSelector, closeSelector, closeClickOverlay = true) {\n        const trigger = document.querySelectorAll(triggerSelector),\n              modal = document.querySelector(modalSelector),\n              close = document.querySelectorAll(closeSelector),\n              windows = document.querySelectorAll('[data-modal]'),\n              scroll = calcScroll();\n\n        trigger.forEach(item => {\n            item.addEventListener('click', (e) => {\n                if (e.target) {\n                    e.preventDefault();\n                }\n\n                windows.forEach(item => {\n                    item.style.display = 'none';\n                });\n    \n                modal.style.display = \"grid\";\n                document.body.style.overflow = \"hidden\";\n                document.body.style.marginRight = `${scroll}px`;\n            });\n        });\n\n        close.forEach(item => {\n            item.addEventListener('click', () => {\n                windows.forEach(item => {\n                    item.style.display = 'none';\n                });\n                modal.style.display = \"none\";\n                document.body.style.overflow = \"\";\n                document.body.style.marginRight = `0px`;\n            });\n        });\n\n        modal.addEventListener('click', (e) => {\n            if (e.target === modal && closeClickOverlay) {\n                windows.forEach(item => {\n                    item.style.display = 'none';\n                });\n\n                modal.style.display = \"none\";\n                document.body.style.overflow = \"\"; \n                document.body.style.marginRight = `0px`;\n            }\n        });\n    }\n\n    function showModalByTime(selector, time) {\n        setTimeout(function() {\n            let display;\n\n            document.querySelectorAll('[data-modal]').forEach(item => {\n                if (getComputedStyle(item).display !== 'none') {\n                    display = \"block\";\n                }\n            });\n\n            if (!display) {\n                document.querySelector(selector).style.display = 'block';\n                document.body.style.overflow = \"hidden\";\n            }\n        }, time);\n    }\n\n    function calcScroll() {\n        let div = document.createElement('div');\n\n        div.style.width = '50px';\n        div.style.height = '50px';\n        div.style.overflowY = 'scroll';\n        div.style.visibility = 'hidden';\n\n        document.body.appendChild(div);\n        let scrollWidth = div.offsetWidth - div.clientWidth;\n        div.remove();\n\n        return scrollWidth;\n    }\n\n    bindModal('.button-callback', '.modal-callback', '.modal-close, .modal-dialog');\n    bindModal('.button-price', '.modal-price', '.modal-close, .modal-dialog');\n    bindModal('.button-deg', '.modal-deg', '.modal-close, .modal-dialog');\n    bindModal('.button-special', '.modal-special', '.modal-close, .modal-dialog');\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (modals);\n\n//# sourceURL=webpack://start-template/./src/js/modules/modal.js?");
